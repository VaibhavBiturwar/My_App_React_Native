...
export const MyMapView = () => {
  return (
    <View style={{ flex: 1, border: 10 }}>
      ...
      >
        <Marker
          coordinate={{ latitude: 21.247782, longitude: 81.665302 }}
          title="Pin POint"
          // image={{ uri: imgurl }}
        >
          <View></View>
